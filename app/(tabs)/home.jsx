...
import { SafeAreaView, FlatList, Image, RefreshControl, Text, View } from "react-native";
...
const Home = () => {
  ...
  const handleFavoriteToggle = useCallback((postId) => {
    setFavorites((prevFavorites) => {
      const updatedFavorites = new Set(prevFavorites);
      if (updatedFavorites.has(postId)) {
